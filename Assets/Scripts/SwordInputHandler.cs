...
public class SwordInputHandler : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    public RectTransform touchArea; // Touch detection area (this GameObject)
    ...
    public static SwordInputHandler Instance;
    ...
    void Update()
    {
        // Send input to sword rotator
        if (SwordRotator.Instance != null)
        {
            SwordRotator.Instance.SetRotationInput(inputVector);
        }
    }
